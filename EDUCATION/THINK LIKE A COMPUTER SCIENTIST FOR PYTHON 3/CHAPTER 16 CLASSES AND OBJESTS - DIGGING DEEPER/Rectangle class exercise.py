...
# small box inside large box but roles are reversed
rec2 = Rectangle(Point(1,1), 4, 3)
rec1 = Rectangle(Point(3,2), 1, 1)
test(rec1.collides(rec2), True)

# small box point touching large box in the left-bot corner
rec1 = Rectangle(Point(1,1), 4, 3)
rec2 = Rectangle(Point(0,5), 1, 1)
test(not rec1.collides(rec2), True)

# small box point touching large box in the right-bot corner
rec1 = Rectangle(Point(1,1), 4, 3)
rec2 = Rectangle(Point(5,4), 1, 1)
test(not rec1.collides(rec2), True)

# small box point touching large box in the left-top corner
rec1 = Rectangle(Point(1,1), 4, 3)
rec2 = Rectangle(Point(0,0), 1, 1)
test(not rec1.collides(rec2), True)

# small box point touching large box in the right-top corner
rec1 = Rectangle(Point(1,1), 4, 3)
rec2 = Rectangle(Point(5,0), 1, 1)
test(not rec1.collides(rec2), True)

# small box at the bottom of large box
rec1 = Rectangle(Point(1,1), 4, 3)
rec2 = Rectangle(Point(3,4), 1, 1)
test(not rec1.collides(rec2), True)

# small box on the right side of the large box
rec2 = Rectangle(Point(1,1), 4, 3)
rec1 = Rectangle(Point(5,2), 1, 1)
test(not rec1.collides(rec2), True)

# small box on the right side but not at the bound
rec2 = Rectangle(Point(1,1), 4, 3)
rec1 = Rectangle(Point(4.99999,2), 1, 1)
test(rec1.collides(rec2), True)

# small box at large box's top bound
rec2 = Rectangle(Point(1,1), 4, 3)
rec1 = Rectangle(Point(4,1), 1, 1)
test(rec1.collides(rec2), True)

# small box at large box's left bound
rec2 = Rectangle(Point(1,1), 4, 3)
rec1 = Rectangle(Point(0,2), 1, 1)
test(not rec1.collides(rec2), True)
